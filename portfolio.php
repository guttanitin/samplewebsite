...
$changeperc = round((($closeprices[0] - $closeprices[1]) / ($closeprices[1])),2) * 100;
    ...
    <div class="container-fluid" style="font-size: 18px; background-color: #dddddd">
        ...
        <div class = "row" id = "result">
                <table id ="datatable" class = "display">
                    ...
                    <tbody>
                            <tr>
                                <td> <a href="https://hedgetechtest.azurewebsites.net/stock.php?useremail=<? echo $symbols;?>"> <? echo $symbols; ?> </a></td>
                                <td> <? echo $symbols; ?>  </td>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="portfolio.php" method="post" id="searchForm">
                      <input type="text" name="s" id="s" placeholder="Search...">
                      <button type="submit" class="btn btn-success"> Add Symbol</button>
                  </form>
                </div>
