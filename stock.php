...
//grabs the searched stock
$stock = $_GET['stock'];
$stocks = 'AAPL';
$symbol = 'WIKI/'.$stock;
$symbols = 'WIKI/AAPL';
//gets all the data in the database for stock chosen
...
$previousclose = $closeprices[1];
$range52 = $closeprices[364] . ' - ' . $closeprices[0];
$dayrange = $daylow[0] . ' - ' . $dayhigh[0];
$volumes = $volume[0];
$avgvol = $adjvol[0];
$open = $openprices[0];
...
$feedlist = new rss("http://articlefeeds.nasdaq.com/nasdaq/symbols?symbol=$stock");
    ...
    <div class="container-fluid" style="font-size: 18px; background-color: #dddddd">
        <div class ="row">
            ...
            <div class = "col-sm-4 col-lg-4">
                <div class ="well">
                    <table>
                        <h2 style="text-align: center"><? echo $stock; ?> Information: </h2>
                        <p style="text-align: center">Closing Price: <?php echo $closeprices[0]; ?></p>
                        <thead>
                        <tr>
                            <th style="background-color: #dddddd">Information:</th>
                            <th style="background-color: #dddddd">Values: </th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>Previous Close</td>
                            <td><?php echo  $previousclose; ?></td>
                        </tr>
                        <tr>
                            <td>Open</td>
                            <td><?php echo  $open; ?></td>
                        ...
                        <tr>
                            <td>Day's Range</td>
                            <td><?php echo  $dayrange; ?></td>
                        </tr>
                        <tr>
                            <td>52 Week Range</td>
                            <td><?php echo  $range52; ?></td>
                        </tr>
                        <tr>
                            <td>Volume</td>
                            <td><?php echo  $volumes; ?></td>
                        </tr>
                        <tr>
                            <td>Average Volume</td>
                            <td><?php echo  $avgvol; ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class = "col-sm-6 col-lg-6">
                <div class = "well">
                    <h2 style="text-align: center"><? echo $stock ?> Price Change over Last 30 Days: </h2>
                    <iframe src="https://hedgetechtest.azurewebsites.net/area30.php?COMPANY=<?php echo $stock;?>" width="600" height="350" scrolling="no" style="padding-left: 25px;
                overflow:hidden; margin-top:0px; margin-left:0px; border:none;" frameborder="1"></iframe>
                </div>
            </div>
        </div>

        <div class = "row">
            <div class = "col-sm-12 col-lg-12" id="feedControl">
                <? echo $feedlist->display(15,"$stock News"); ?>
            </div>
        </div>
        <!-- /.container-fluid-->
        <!-- /.content-wrapper-->
