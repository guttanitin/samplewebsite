...
$feedlist = new rss("http://articlefeeds.nasdaq.com/nasdaq/symbols?symbol=$stocks");
    ...
    <div class="container-fluid" style="font-size: 18px; background-color: #dddddd">
        <div class ="row">
            ...
            <div class = "col-sm-4 col-lg-4">
                <div class ="well">
                <table>
                    <h2 style="text-align: center">Apple Information: </h2>
            ...
            <div class = "col-sm-6 col-lg-6">
                <div class = "well">
                    <h2 style="text-align: center">Apple Price Change over Last 30 Days: </h2>
                <iframe src="https://hedgetechtest.azurewebsites.net/area30.php?COMPANY=AAPL" width="600" height="350" scrolling="no" style="padding-left: 25px;
        ...
        <div class = "row">
            <div class = "col-sm-12 col-lg-12">
                <? echo $feedlist->display(20,"$stocks News"); ?>
            </div>
        </div>
        <!-- /.container-fluid-->
        <!-- /.content-wrapper-->
