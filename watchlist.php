...
$change = $closeprices[0] - $closeprices[1];
$changeperc = round((($closeprices[0] - $closeprices[1]) / ($closeprices[1])),2);
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <ul class="navbar-nav navbar-sidenav fa-ul" id="exampleAccordion" style="font-size: 25px; padding-top: 30px; min-width: 0px; left: -7px;">
            <li class="nav-item" data-placement="right">
                ...
                <a class="nav-link" href="watchlist.php" style="font-size: 20px;"> <i class="fa fa-male"></i> <span class="nav-link-text">Watchlist</span><br></a>
                <a class="nav-link" href="#" style="font-size: 20px;"> <i class="fa fa-link"></i> <span class="nav-link-text">Portfolio</span><br></a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <h4 class="modal-title">Enter Symbol of Stock</h4>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
     
                <!-- Modal body -->
                <div class="modal-body">
                  <form action="watchlist.php" method="post" id="searchForm">
